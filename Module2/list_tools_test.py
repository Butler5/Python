...
self.assertEqual(list_tools.all_even([17, 21, 37, 18, 14, 19, 12, 9, -98,
100, -13, -11]),
[18, 14, 12, -98, 100])
...
self.assertEqual(list_tools.all_not_multiple([17, 21, 37, 18, 14, 19, 12],
7),
[17, 37, 18, 19, 12])
...
self.assertEqual(list_tools.max_from_2_tuples([(-100, -500), (-300, -200),
(-50, -700)]), (-50, -200))
self.assertEqual(list_tools.max_from_2_tuples([(0, 0)]), (0, 0))
self.assertEqual(list_tools.max_from_2_tuples([(10, 20), (13, 23), (16,
26), (5, 5)]), (16, 26))
self.assertEqual(list_tools.max_from_2_tuples([(0, 0), (0, 0), (0, 0)]),
(0, 0))
self.assertEqual(list_tools.max_from_2_tuples([(-5, -6), (-5, -6), (-5, -
6)]), (-5, -6))
def test_lower_case_words(self):
self.assertEqual(list_tools.lower_case_words("Every good boy does fine"),
["every", "good", "boy", "does", "fine"])
self.assertEqual(
list_tools.lower_case_words("Words are SEPARATed by ONE or
more space characters"),
["words", "are", "separated", "by", "one", "or", "more", "space",
"characters"])
self.assertEqual(list_tools.lower_case_words(""), [])
def test_baby_names(self):
self.assertEqual(list_tools.baby_names(["Mark", "Allen", "Steve"],
"Smith"),
